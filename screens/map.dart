...
import 'package:myfinal/screens/display.dart';
final _firestore = FirebaseFirestore.instance;
double latFrom,longFrom,latTo,longTo;
String currentUsermap;
...
class _mapnavState extends State<mapnav> {
  ...
  Future<void> initialize() async {
    ...
    _options = MapBoxOptions(
        initialLatitude: 30.013056,
        initialLongitude:31.208853,
        zoom: 15.0,
        tilt: 0.0,
        bearing: 0.0,
        enableRefresh: false,
  ...
  Future<void> _onEmbeddedRouteEvent(e) async {
    ...
    switch (e.eventType) {
      ...
      case MapBoxEvent.on_arrival:
        ...
        if(_arrived==true)
          {
             _firestore.collection('provider').doc('$currentUsermap').update({'state': 'Request'});
          }
        if (!_isMultipleStop) {
